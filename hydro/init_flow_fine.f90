...
subroutine init_flow_fine(ilevel)
  ...
  real(dp),allocatable,dimension(:,:,:)::init_array,init_array2 !14/01/2021 BiP
  real(kind=4),allocatable,dimension(:,:)::init_plane,init_plane2 !BiP

  logical::error,ok_file1,ok_file2,ok_file3,ok_file
  character(LEN=80)::filename, filename2 !BiP 14/01/2021
  ...
  if(ok_file)then
     ...
     if(ncache>0)allocate(init_array2(i1_min:i1_max,i2_min:i2_max,i3_min:i3_max)) !14/01/2021 BiP
     allocate(init_plane(1:n1(ilevel),1:n2(ilevel)))
     allocate(init_plane2(1:n1(ilevel),1:n2(ilevel)))                             !14/01/2021 BiP
     ...
     do ivar=1,nvar
        if(cosmo)then
           ...
           if(multiple)then
              ...
              if(ivar==1)filename2=TRIM(initfile(ilevel))//'/mask' ! BiP for Dirac-Milne read the mask also
        ...
        if(ok_file3)then
           ...
           if(multiple)then
              ...
              if(myid==1)then
                 ...
                 open(11,file=filename2,form='unformatted') !BiP reading of the mask file
                 rewind 11
              ...
              do i3=1,n3(ilevel)
                 if(myid==1)then
                    ...
                    read(11)((init_plane2(i1,i2),i1=1,n1(ilevel)),i2=1,n2(ilevel))
                 else
                    init_plane=0
                    init_plane2=0
                 endif
                 ...
                 call MPI_BCAST(init_plane2,buf_count,MPI_REAL,0,MPI_COMM_WORLD,info)
#endif
                 if(ncache>0)then
                    if(i3.ge.i3_min.and.i3.le.i3_max)then
                       init_array(i1_min:i1_max,i2_min:i2_max,i3) = &
                            & init_plane(i1_min:i1_max,i2_min:i2_max)
                       init_array2(i1_min:i1_max,i2_min:i2_max,i3) = &   !BiP mask
                              & init_plane2(i1_min:i1_max,i2_min:i2_max)
                    end if
                 endif
              end do
              if(myid==1)close(10)
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!BiP Here the first species is stored in the hydro sector while the cond one is treated as particles
		if(ivar==1.and.init_array2(i1,i2,i3)==0)then                                                          
              		uold(icell,ivar)=smallr
                else
			if(ivar==1.and.init_array2(i1,i2,i3)==1)then                                                             
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!BiP
     ...
     if(ncache>0)deallocate(init_array,init_array2) !14/01/2021 BiP
     deallocate(init_plane,init_plane2) !BiP
