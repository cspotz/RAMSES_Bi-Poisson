...
subroutine rho_fine(ilevel,icount)
  ...
  ! Array rho, rho_m and cpu_map2 are stored with:
  ! - rho containing the Poisson source term
  ! - rho_m containing the Poisson source term
  ...
  !-------------------------------------------------------
  ! Initialize rho and rho_m to analytical and baryon density field
  !-------------------------------------------------------
...
subroutine cic_amr(ind_cell,ind_part,ind_grid_part,x0,ng,np,ilevel)
  ...
  !------------------------------------------------------------------
  ! Stahl 23/01/2020
  ! Modification of this routine to include a second density rho_m
  !------------------------------------------------------------------
